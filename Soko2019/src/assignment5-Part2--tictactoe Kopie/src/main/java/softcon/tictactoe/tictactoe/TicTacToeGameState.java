...
public class TicTacToeGameState implements DiscreteGameState {
  ...
  public Player getCurrentPlayer() {
    Player randomPlayer = this.currentPlayer;
  ...
  private boolean completesDiagonal(Player player) {
    ...
    return (board.getMark(0, 0) == player && player == board.getMark(2, 2)&& center == player)
        || (board.getMark(0, 2) == player && player == board.getMark(0, 0)&& center == player);
  }
